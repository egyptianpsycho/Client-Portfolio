    ...
    <div className="mt-94 relative" id="PROJECTS">
      <div>
        <div className=" z-100 text-center ">
          <h1
            className="text-9xl max-sm:text-[2.7rem] mb-5 relative inset-0 -top-90 max-sm:tracking-[0.4rem] tracking-[1.1rem] whitespace-nowrap   behind-title2 font-bold  text-gradient  "
            style={{
