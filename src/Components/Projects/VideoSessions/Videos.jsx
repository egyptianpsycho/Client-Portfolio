          ...
          {PROJECTSVIDS.map((project, index) => (
            ...
            >
              <VideoPlayer
                ...
                classN="object-cover h-full w-full grayscale-75 transition-all duration-500 ease-out group-active:grayscale-0"
              />
...
//       {isMobile ? (
//         /* ── Mobile: full-width grid, all videos ── */
//         <div
//           style={{
//             display: "grid",
...
//                 <span className="text-white/50 text-[0.45rem] font-semibold">
//                   {project.durtaion}
//                 </span>
//               </div>
//             </div>
