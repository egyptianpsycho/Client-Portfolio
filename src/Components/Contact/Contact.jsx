      ...
      <div className="w-full min-h-screen absolute text-white overflow-hidden flex justify-center items-start p-8">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 relative z-10">
          ...
          <div className="space-y-6 ml-4">
            ...
            <div className="">
              <div className="absolute inset-0 top-26 right-120 z-99 mix-blend-exclusion pointer-events-none max-sm:inset-0 max-sm:right-10 max-sm:bottom-76">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
                  height="100%"
...
//             <form method="post" action="https://formspree.io/f/mzzqwoal" className="space-y-6 max-w-[40rem] max-sm:w-[20rem] text-lg">
//               <div>
//                 <input
//                   type="text"
//                   name="name"
