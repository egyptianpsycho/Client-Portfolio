...
const Chat = () => {
  ...
  return (
    <>
      {/* Landing Page */}
      <div id="BOOK" className="relative min-h-screen bg-gradient-to-b from-black via-[#121E25] to-[#09131B] flex items-center justify-center p-4 sm:p-6 overflow-hidden mb-0.5 -mt-0.5">
        {/* Background elements */}
