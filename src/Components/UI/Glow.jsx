    ...
    <div className="relative ">
      <div className="relative  -mb-50">
        <div className="glow-text">
          <span className="filter2 text-8xl ">{text}</span>
        </div>
        <div className="filter-container" data-component-list="TextGlow">
          <svg width="1440px" height="300px" viewBox="0 0 1440 300">
            <defs>
              <filter
                id="glow-1"
