...
const Partners = () => {
  ...
  return (
    <section className="-mb-0.1  min-h-screen h-auto sm:h-screen z-[100] pt-0  sm:pt-32 md:pt-40 pb-10 sm:pb-0 overflow-hidden bg-gradient-to-br to-[#000000] from-[#0a212b] flex items-center justify-center" id="PARTNERS">
